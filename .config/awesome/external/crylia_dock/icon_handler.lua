...
local fallback = "/usr/share/icons/WhiteSur-dark/apps/scalable/application-default-icon.svg"
-- /usr/share/icons/WhiteSur-dark/apps/scalable/application-default-icon.svg
...
function Get_icon(theme, client, program_string, class_string, is_steam)
  ...
  if theme and (client or program_string or class_string) then
    ...
    WhiteSur_bruh = ""
    if theme == "WhiteSur-dark" then WhiteSur_bruh = "scalable/" end
    ...
    for _, res in ipairs(resolutions) do
      ...
      local iconDir = "/usr/share/icons/" .. theme .. "/" .. "/apps/" .. WhiteSur_bruh
      local ioStream = io.open(iconDir .. clientName, "r")
      print(iconDir .. clientName)
      if ioStream ~= nil then
        ...
        iconDir = "/usr/share/icons/" .. theme .. "/" .. "/apps/" .. WhiteSur_bruh
